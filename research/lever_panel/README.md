...
`server_time_proof.csv` checks every source commit behind every trade date against times that GitHub itself recorded. Git commit dates are not used as proof. There is one row per (trade_date, source file), 234 rows in all, covering 100 distinct commits.

- **How the proof works.** Each commit was matched to the Actions workflow run that pushed it. The match comes from the `old..new  main -> main` line in that run's job log: the commit must be in `git rev-list old..new`. The run's `created_at` has to be after 16:00 ET on the snapshot day, and its `updated_at` has to be before 09:30 ET on the trade date. `server_time_utc` is the run's `updated_at`, the time by which the push had finished. For 63 of the 100 commits, the repo PushEvent (actor `github-actions[bot]`, available from 2026-08-27 on) also falls inside the window and inside the run.
- **Results.** Every source commit was pushed by exactly one Actions run, and all of those runs are attempt 1. **No source commit was made by hand, and no server time falls outside its window.** Three runs were started manually with `workflow_dispatch`, but their commits were still produced by the workflow: run 31247191433 (Score Delta for 08-07, used on trade_date 2026-08-10) and runs 36187437404, 36187670590 and 36188094956 (snapshot, score and composite for 09-25, used on trade_date 2026-09-28).
- **Counts (trade dates).** PROVEN **35**, PARTIAL **0**, NOT PROVEN **0**. 20 of the PROVEN dates fall in 08-13 … 09-11.
- **PROVEN:** 2026-08-07, 2026-08-10, 2026-08-11, 2026-08-12, 2026-08-13, 2026-08-14, 2026-08-17, 2026-08-18, 2026-08-19, 2026-08-20, 2026-08-21, 2026-08-24, 2026-08-25, 2026-08-26, 2026-08-27, 2026-08-31, 2026-09-01, 2026-09-02, 2026-09-03, 2026-09-04, 2026-09-08, 2026-09-09, 2026-09-10, 2026-09-11, 2026-09-14, 2026-09-15, 2026-09-16, 2026-09-17, 2026-09-18, 2026-09-21, 2026-09-22, 2026-09-23, 2026-09-24, 2026-09-25, 2026-09-28.
- **PARTIAL:** none. **NOT PROVEN:** none.
- **Caveat.** Families left empty in the panel have no source commit, so there is nothing for them to prove. These are 2026-08-07 (all `tr*_`/`seg_`), `seg_` on 08-10 and 08-11, and `trc_` before 08-13. For 2026-08-07, the snapshot itself is proven by run 31136381205 (created 2026-08-07T00:56:46Z = 20:56 ET 08-06).
